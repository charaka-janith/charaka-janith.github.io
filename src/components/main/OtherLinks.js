...
export default function OtherLinks () {
    return (
        <section className="text-gray-400" id="follow">
                ...
                <div className="flex flex-col w-full">
                    <div className="m-auto">
                      ...
                      <a href="https://g.dev/charaka-janith" className="mybtn sticky z-10" rel="noreferrer"
                        ...
                        <a href="https://www.facebook.com/b.v.charaka.janith" className="mybtn sticky z-10"
                           rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Brand_icons.faFacebook} size="6x"
                                                            transform="shrink-6"/></a>
                        <a href="https://twitter.com/CHARAKAJANITH1" className="mybtn sticky z-10" rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Brand_icons.faTwitter} size="6x"
                                                            transform="shrink-6"/></a>
                        <a href="https://www.hackthebox.eu/profile/269679" className="mybtn sticky z-10"
                           rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Solid_icons.faCube} size="6x"
                                                            transform="shrink-6"/></a>
                        <a href="https://tryhackme.com/p/charakajanith" className="mybtn sticky z-10" rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Solid_icons.faCloudMeatball} size="6x"
                                                            transform="shrink-6"/></a>
                        <a href="https://www.hackerrank.com/charakajanithba1" className="mybtn sticky z-10"
                           rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Brand_icons.faHackerrank} size="6x"
                                                            transform="shrink-6"/></a>
                        <a href="https://charaka-janith.business.site" className="mybtn sticky z-10" rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Solid_icons.faHotel} size="6x" transform="shrink-6"/></a>
                        <a href="https://www.youtube.com/channel/UCuPZ5lvZjwVnZn8ZD_kmzmw" className="mybtn sticky z-10"
                           rel="noreferrer"
                           target="_blank"><FontAwesomeIcon icon={Brand_icons.faYoutube} size="6x"
                                                            transform="shrink-6"/></a>
                    </div>
                </div>
